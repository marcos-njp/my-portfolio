export const githubProjects = [
  {
    ...
    highlights: [
      ...
      "Professional and casual response modes",
      "Streaming responses with session memory",
      "Personality grounded in a structured knowledge base",
    ],
  },
  {
    ...
    highlights: [
      ...
      "Analytics for academic insights",
      "Built for real staff and real data",
      "Scoped and maintained as a capstone project",
    ],
  },
  {
    name: "Nihilita",
    ...
    highlights: [
      ...
      "Firebase backend and NoSQL data",
