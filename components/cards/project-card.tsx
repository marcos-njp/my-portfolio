    ...
    >
      ...
      <CardContent className="p-3.5 space-y-2.5">
        ...
        <Button 
          variant="ghost" 
          size="sm" 
          className="w-full text-xs h-8 hover:bg-primary hover:text-primary-foreground transition-colors group-hover:bg-primary/10 dark:group-hover:bg-primary/20 dark:hover:bg-primary dark:hover:text-primary-foreground"
          onClick={(e) => {
            e.stopPropagation()
            onClick()
          }}
